...
cp -r public "$Z/"
cp functions-appel-loyer/{index.js,relais-fichiers.js,signature-distante.js,courriel.js,package.json,package-lock.json} "$Z/functions-appel-loyer/"
cp functions-appel-loyer/lib/{appel-loyer.js,contradictoire.js,courriel-enveloppe.js} "$Z/functions-appel-loyer/lib/"
cp livraison/DEPLOYER.cmd livraison/RETIRER-ANCIEN-ENVOI.cmd "$Z/"
